...
class UserController extends AdminBaseController
{
    ...
    public function index()
    {
        ...
        $users = Db::name('user')
            ->where('user_type', 1)->where('companyid', 0)
    ...
    public function add()
    {
        ...
        $roles = Db::name('role')->where('status', 1)->where('companyid', 0)->order("id DESC")->select();
        $this->assign("roles", $roles);
        return $this->fetch();
    }
    ...
    public function edit()
    {
        ...
        $roles = DB::name('role')->where('companyid', 0)->where('status', 1)->order("id DESC")->select();
        $this->assign("roles", $roles);
        $role_ids = DB::name('RoleUser')->where('companyid', 0)->where("user_id", $id)->column("role_id");
