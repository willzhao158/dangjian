...
use app\farm\model\TaskModel;
use think\Db;
Class TaskController extends FarmbaseController
{
    public $table = 'ny_task';
	...
	public function editaction(){
		$result = $this->model->edittask(input());
		if($result){
    ...
    public function gettaskDetail(){
    	return $this->model->gettaskDetail(input());
    }
}