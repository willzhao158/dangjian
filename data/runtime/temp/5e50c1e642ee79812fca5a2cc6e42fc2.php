<?php /*a:2:{s:90:"/www/wwwroot/guocai.yzata.cn/public/themes/admin_simpleboot3/order/index/interest_way.html";i:1577609632;s:77:"/www/wwwroot/guocai.yzata.cn/public/themes/admin_simpleboot3/public/farm.html";i:1577019110;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
      ...
      <div class="layui-card-body">
        <div class="demoTable">
          <div class="layui-inline">
            <input class="layui-input" name="id" id="demoReload" autocomplete="off" placeholder="请输入付息方式">
          </div>
          <button class="layui-btn" data-type="reload">搜索</button>
          <button class="layui-btn " data-type="addPlace">新增付息方式</button>
          <button class="layui-btn " data-type="delPlace">删除付息方式</button>
...
layui.use(['table','layer','form','laydate'], function(){
  ...
  table.render({
    elem: '#Place'
    ,url: "/index/getinterestway/"
    
    ,cols: [[
      {checkbox: true, fixed: true}
      ,{field:'name', title: '付息方式', edit: 'text'}
    ]]
    ,id: 'PlaceReload'
    ,page: true
  ...
  var $ = layui.$, active = {
    ...
    addPlace:function(){
      $.post('/index/addinterestway',function(res){
        if(res.code){
          table.reload('PlaceReload');
    ...
    var data = checkStatus.data;
        ...
        layer.confirm('确定删除吗？',{icon:3},function(index){
          $.post('/index/delinterestway',{params:id.join(',')},function(res){
            if(res.code){
              table.reload('PlaceReload');
              layer.msg(res.msg,{icon:1});
            }else{
  ...
  form.on('select(tran_company)', function(data){
    ...
    $.post('/index/editinterestway',{params:update},function(res){
      if(res.code){
        layer.msg(res.msg);
      }else{
        table.reload('PlaceReload');
