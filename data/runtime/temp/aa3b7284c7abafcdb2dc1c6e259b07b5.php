<?php /*a:1:{s:84:"/www/wwwroot/paopao.yzata.cn/public/themes/admin_simpleboot3/mobile/login/login.html";i:1590457957;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
                    ...
                    <div class="weui-cells__group weui-cells__group_form">
                        <div class="weui-cells weui-cells_form">
                            ...
                            <div class="weui-cell weui-cell_active">
                                ...
                                <div class="weui-cell__bd">
                                    <input class="weui-input" type="text" pattern="[0-9]*" id="code" placeholder="输入验证码"/>
                                </div>
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if(data['code'] == 1){
                            ...
                            showToastSuccess(data['msg']);
                            setTimeout(function(){ window.location.href = "<?php echo url('register/index'); ?>"; }, 2000);
                        }else{
                            showToastError(data['msg']);
                            return false;
                        }
