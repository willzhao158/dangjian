<?php /*a:2:{s:88:"D:\xampp\htdocs\guocai.yzata.cn\public/themes/admin_simpleboot3/order\index\adviser.html";i:1577871267;s:80:"D:\xampp\htdocs\guocai.yzata.cn\public/themes/admin_simpleboot3/public\farm.html";i:1577019110;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
      ...
      <div class="layui-card-body">
        <div class="demoTable">
          <div class="layui-inline">
            <input class="layui-input" name="id" id="demoReload" autocomplete="off" placeholder="请输入投资顾问">
          </div>
          <div class="layui-inline">
          ...
          <button class="layui-btn " data-type="addPlace">新增投资顾问</button>
          <button class="layui-btn " data-type="delPlace">删除投资顾问</button>
...
layui.use(['table','layer','form','laydate'], function(){
  ...
  table.render({
    elem: '#Place'
    ,url: "/index/getadviser/"
    ,cols: [[
      {checkbox: true, fixed: true}
      ,{field:'name', title: '投资顾问', edit: 'text'}
      ,{field:'company', title: '所属分公司', edit: 'text',toolbar: '#selectCom'}
    ]]
    ,id: 'PlaceReload'
    ,page: true
  ...
  var $ = layui.$, active = {
    ...
    addPlace:function(){
      $.post('/index/addadviser',function(res){
        if(res.code){
          table.reload('PlaceReload');
    ...
    var data = checkStatus.data;
        ...
        layer.confirm('确定删除吗？',{icon:3},function(index){
          $.post('/index/deladviser',{params:id.join(',')},function(res){
            if(res.code){
              table.reload('PlaceReload');
              layer.msg(res.msg,{icon:1});
            }else{
  ...
  form.on('select(tran_company)', function(data){
    ...
    $.post('/index/editadviser',{params:update},function(res){
      if(res.code){
        layer.msg(res.msg);
      }else{
        table.reload('PlaceReload');
