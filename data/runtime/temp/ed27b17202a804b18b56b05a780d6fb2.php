<?php /*a:2:{s:88:"D:\xampp\htdocs\guocai.yzata.cn\public/themes/admin_simpleboot3/order\index\product.html";i:1577609790;s:80:"D:\xampp\htdocs\guocai.yzata.cn\public/themes/admin_simpleboot3/public\farm.html";i:1577019110;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
      ...
      <div class="layui-card-body">
        <div class="demoTable">
          <div class="layui-inline">
            <input class="layui-input" name="id" id="demoReload" autocomplete="off" placeholder="请输入产品">
          </div>
          <button class="layui-btn" data-type="reload">搜索</button>
          <button class="layui-btn " data-type="addPlace">新增产品</button>
          <button class="layui-btn " data-type="delPlace">删除产品</button>
...
layui.use(['table','layer','form','laydate'], function(){
  ...
  var $ = layui.$, active = {
    ...
    addPlace:function(){
      $.post('/index/addproduct',function(res){
        if(res.code){
          table.reload('PlaceReload');
    ...
    var data = checkStatus.data;
        ...
        layer.confirm('确定删除吗？',{icon:3},function(index){
          $.post('/index/delproduct',{params:id.join(',')},function(res){
            if(res.code){
              table.reload('PlaceReload');
              layer.msg(res.msg,{icon:1});
            }else{
  ...
  table.on('edit(Place)', function(obj){
    ...
    $.post('/index/editproduct',{params:update},function(res){
      if(res.code){
        layer.msg(res.msg);
      }else{
        table.reload('PlaceReload');
